...
use search::systems::recolor::{
    process_pending_recolor_updates, spawn_pending_color_updates,
    spawn_quantity_of_skipped_path_on_recolor,
};
use search::systems::{execute_maze_table_tasks, spawn_maze_table_tasks_receiver};
use user_interface::spawn_main_menu;
use user_interface::system::animation_speed_button::{
    change_speed_bar_length, change_speed_of_search_animation,
};
use user_interface::system::choose_maze_button::choose_maze_button_system;
use user_interface::system::hover_button::button_styled_when_mouse_interaction;
...
fn main() {
    App::new()
        ...
        .add_systems(
            Startup,
            (
                spawn_maze_table_tasks_receiver,
        ...
        .add_systems(Update, change_speed_of_search_animation)
        .add_systems(Update, change_speed_bar_length)
        .run();
}
